...
# The voting for this change is a round-based procedure. In 
...
class Solution:
    def predictPartyVictory(self, senate: str) -> str:
        # best move is to always take out the senator on the other team who is voting next
        # do this and add to last of queue senator who just went until we have none of the other team left
